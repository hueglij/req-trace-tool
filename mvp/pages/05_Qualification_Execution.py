...
_save_container = render_sticky_header("Qualification Execution (xQ)", with_save=True)
...
with st.container():
    ...
    save_exec_clicked = _save_container.button("Save Results", disabled=not can_edit_exec)
