...
from app_core.utils import (
    safe_str, safe_int, calculate_quantification, calculate_risk_level, excel_to_bool,
...
_save_container = render_sticky_header("Risk Assignment", with_save=True)
...
with st.container():
    ...
    save_all_clicked = _save_container.button("Save Risk Assessments", disabled=not can_edit_risk)
